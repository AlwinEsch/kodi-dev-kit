...
namespace ADDON
{
  ...
  class CBinaryAddonSharedMemoryPosix : public CBinaryAddonSharedMemory
  {
  public:
    CBinaryAddonSharedMemoryPosix(CBinaryAddon* addon, int randNumber, size_t size = DEFAULT_SHARED_MEM_SIZE);
