...
#define SWIG_name      "kodi"
#define SWIG_init      luaopen_kodi
#define SWIG_init_user luaopen_kodi_user

#define SWIG_LUACODE   luaopen_kodi_luacode
...
static int _wrap_Log(lua_State* L) {
  ...
  SWIG_check_num_args("kodi::Log",2,2)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("kodi::Log",1,"addonLog const");
  if(!SWIG_lua_isnilstring(L,2)) SWIG_fail_arg("kodi::Log",2,"char const *");
  arg1 = (addonLog const)(int)lua_tonumber(L, 1);
  arg2 = (char *)lua_tostring(L, 2);
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_INT("LOG_NOTICE", LOG_NOTICE)},
    {SWIG_LUA_CONSTTAB_INT("LOG_WARNING", LOG_WARNING)},
    {SWIG_LUA_CONSTTAB_INT("LOG_ERROR", LOG_ERROR)},
    {SWIG_LUA_CONSTTAB_INT("LOG_SEVERE", LOG_SEVERE)},
