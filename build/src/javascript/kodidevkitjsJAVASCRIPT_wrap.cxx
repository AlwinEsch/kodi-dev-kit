...
#define SWIGTYPE_p_addonLog swig_types[0]
...
#define SWIGV8_INIT kodidevkit_initialize




static SwigV8ReturnValue _wrap_LOG_DEBUG(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  
  jsresult = SWIG_From_int((int)(LOG_DEBUG));
...
static SwigV8ReturnValue _wrap_LOG_INFO(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  
  jsresult = SWIG_From_int((int)(LOG_INFO));
...
static SwigV8ReturnValue _wrap_LOG_NOTICE(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  
  jsresult = SWIG_From_int((int)(LOG_NOTICE));
...
static SwigV8ReturnValue _wrap_LOG_WARNING(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  
  jsresult = SWIG_From_int((int)(LOG_WARNING));
...
static SwigV8ReturnValue _wrap_LOG_ERROR(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  
  jsresult = SWIG_From_int((int)(LOG_ERROR));
...
static SwigV8ReturnValue _wrap_LOG_SEVERE(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  
  jsresult = SWIG_From_int((int)(LOG_SEVERE));
...
static SwigV8ReturnValue _wrap_LOG_FATAL(v8::Local<v8::String> property, const SwigV8PropertyCallbackInfo &info) {
  SWIGV8_HANDLESCOPE();
  
  v8::Handle<v8::Value> jsresult;
  
  jsresult = SWIG_From_int((int)(LOG_FATAL));
...
static SwigV8ReturnValue _wrap_Log(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_Log.");
  
  ecode1 = SWIG_AsVal_int(args[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "Log" "', argument " "1"" of type '" "addonLog""'");
  } 
  arg1 = (addonLog)(val1);
  res2 = SWIG_AsCharPtrAndSize(args[1], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Log" "', argument " "2"" of type '" "char const *""'");
  }
  arg2 = (char *)(buf2);
  kodi::Log(arg1,(char const *)arg2,arg3);
...
static swig_type_info _swigt__p_addonLog = {"_p_addonLog", "enum addonLog *|addonLog *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_addonLog[] = {  {&_swigt__p_addonLog, 0, 0, 0},{0, 0, 0, 0}};
...
#endif
{
  ...
  SWIGV8_AddStaticVariable(exports_obj, "LOG_DEBUG", _wrap_LOG_DEBUG, JS_veto_set_variable);
SWIGV8_AddStaticVariable(exports_obj, "LOG_INFO", _wrap_LOG_INFO, JS_veto_set_variable);
SWIGV8_AddStaticVariable(exports_obj, "LOG_NOTICE", _wrap_LOG_NOTICE, JS_veto_set_variable);
SWIGV8_AddStaticVariable(exports_obj, "LOG_WARNING", _wrap_LOG_WARNING, JS_veto_set_variable);
SWIGV8_AddStaticVariable(exports_obj, "LOG_ERROR", _wrap_LOG_ERROR, JS_veto_set_variable);
SWIGV8_AddStaticVariable(exports_obj, "LOG_SEVERE", _wrap_LOG_SEVERE, JS_veto_set_variable);
SWIGV8_AddStaticVariable(exports_obj, "LOG_FATAL", _wrap_LOG_FATAL, JS_veto_set_variable);
  ...
  SWIGV8_AddStaticFunction(exports_obj, "Log", _wrap_Log);
...
NODE_MODULE(kodidevkit, kodidevkit_initialize)
#endif
